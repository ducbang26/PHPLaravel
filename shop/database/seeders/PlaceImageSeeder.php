...
class PlaceImageSeeder extends Seeder
{
    ...
    public function run()
    {
        DB::table('place_images')->insert([
            ...
            ['place_id'=>4, 'image'=>'https://dulichvgo.herokuapp.com/uploads/place_images/caurong1.jpg'],
            ['place_id'=>4, 'image'=>'https://dulichvgo.herokuapp.com/uploads/place_images/caurong2.jpg'],            
