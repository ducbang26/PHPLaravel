    ...
    <form action="" method="POST">
        <div class="card-body">
            ...
            <div class="form-group">
                ...
                <textarea id="content" class="form-control" name="content">{{$menu->content}}</textarea>
            </div>
            <div class="form-group">
                ...
                <div class="custom-control custom-radio">
                    <input class="custom-control-input" value="1" type="radio" id="no_active" name="active" {{$menu->active == 0 ? 'checked' : ''}}>
